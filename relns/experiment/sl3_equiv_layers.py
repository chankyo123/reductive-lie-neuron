...
class SL3EquivariantLayers(nn.Module):
    def __init__(self, in_channels):
        ...
        # # # self.ln_norm = ReLNBatchNorm(feat_dim, dim=4, affine=False, momentum=0.1)
        # self.ln_fc2 = ReLNLinearAndKillingRelu(feat_dim, feat_dim,share_nonlinearity=share_nonlinearity,leaky_relu=leaky_relu)
        self.ln_fc3 = ReLNLinearAndKillingRelu(feat_dim, feat_dim,share_nonlinearity=share_nonlinearity,leaky_relu=leaky_relu)
        # self.ln_fc4 = ReLNLinearAndKillingRelu(feat_dim, feat_dim,share_nonlinearity=share_nonlinearity,leaky_relu=leaky_relu)
        # self.ln_fc5 = ReLNLinearAndKillingRelu(feat_dim, feat_dim,share_nonlinearity=share_nonlinearity,leaky_relu=leaky_relu)
        # self.ln_fc6 = ReLNLinearAndKillingRelu(feat_dim, feat_dim,share_nonlinearity=share_nonlinearity,leaky_relu=leaky_relu)
        self.ln_fc = ReLNLinearAndLieBracket(in_channels, feat_dim,share_nonlinearity=share_nonlinearity)
        self.ln_fc2 = ReLNLinearAndLieBracket(feat_dim, feat_dim,share_nonlinearity=share_nonlinearity)
        # self.ln_fc4 = ReLNLinearAndLieBracket(feat_dim, feat_dim,share_nonlinearity=share_nonlinearity)
        ...
        # self.ln_pooling = ReLNMaxPool(feat_dim, abs_killing_form = False) # [B, F, 8, 1]
...
class SL3EquivariantReluBracketLayers(nn.Module):
    def __init__(self, in_channels):
        ...
        self.ln_fc2 = ReLNLinearAndKillingRelu(
            feat_dim, feat_dim, share_nonlinearity=share_nonlinearity, leaky_relu=leaky_relu)
        self.ln_fc_bracket = ReLNLinearAndLieBracket(in_channels, feat_dim,share_nonlinearity=share_nonlinearity)
        self.ln_fc_bracket2 = ReLNLinearAndLieBracket(feat_dim, feat_dim,share_nonlinearity=share_nonlinearity)
...
class SL3EquivariantBracketNoResidualConnectLayers(nn.Module):
    def __init__(self, in_channels):
        ...
        share_nonlinearity = False
        leaky_relu = True
        self.ln_fc = ReLNLinearAndLieBracketNoResidualConnect(in_channels, feat_dim,share_nonlinearity=share_nonlinearity)
        self.ln_fc2 = ReLNLinearAndLieBracketNoResidualConnect(feat_dim, feat_dim,share_nonlinearity=share_nonlinearity)
...
class SL3InvariantLayersTest(nn.Module):
    def __init__(self, in_channels):
        ...
        self.ln_norm = ReLNBatchNorm(feat_dim, dim=3)
        self.ln_fc2 = ReLNLinearAndKillingRelu(feat_dim, feat_dim)
        self.ln_fc3 = ReLNLinearAndKillingRelu(feat_dim, feat_dim)
        self.ln_inv = ReLNInvariant(method='killing')
