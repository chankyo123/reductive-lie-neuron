...
class SL3InvariantLayers(nn.Module):
    def __init__(self, in_channels):
        ...
        # self.ln_fc2 = ReLNLinearAndKillingRelu(feat_dim, feat_dim,share_nonlinearity=share_nonlinearity)
        # self.ln_fc3 = ReLNLinearAndKillingRelu(
        #     feat_dim, feat_dim, share_nonlinearity=share_nonlinearity)
        self.ln_inv = ReLNInvariant(
...
class SL3InvariantReluBracketLayers(nn.Module):
    def __init__(self, in_channels):
        ...
        self.ln_fc = ReLNLinearAndKillingRelu(
            in_channels, feat_dim, share_nonlinearity=share_nonlinearity)
        self.ln_fc_bracket = ReLNLinearAndLieBracket(
            feat_dim, feat_dim, share_nonlinearity=share_nonlinearity)
        self.ln_inv = ReLNInvariant(
            feat_dim, dir_dim=inv_dir_dim, method='self_killing')
        self.fc_final = nn.Linear(inv_dir_dim*feat_dim, 1, bias=True)
...
class SL3InvariantBracketNoResidualConnectLayers(nn.Module):
    def __init__(self, in_channels):
        ...
        self.ln_fc_bracket = ReLNLinearAndLieBracketNoResidualConnect(
            in_channels, feat_dim, share_nonlinearity=share_nonlinearity)
        # self.ln_fc_bracket2 = ReLNLinearAndLieBracket(feat_dim, feat_dim,share_nonlinearity=share_nonlinearity)
        self.ln_inv = ReLNInvariant(
            feat_dim, dir_dim=inv_dir_dim, method='self_killing')
