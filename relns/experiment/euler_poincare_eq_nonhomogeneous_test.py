...
if __name__ == '__main__':
    ...
    if args.model_type == 'ReLN_ode':
        func = ReLNODEFunc(device=device).to(device)
    elif args.model_type == 'ReLN_ode2':
        func = ReLNODEFunc2(device=device).to(device)
    elif args.model_type == 'ReLN_ode3':
        func = ReLNODEFunc3(device=device).to(device)
    elif args.model_type == 'ReLN_ode4':
        func = ReLNODEFunc4(device=device).to(device)
    elif args.model_type == 'ReLN_ode5':
        func = ReLNODEFunc5(device=device).to(device)
    elif args.model_type == 'ReLN_ode6':
        func = ReLNODEFunc6(device=device).to(device)
    elif args.model_type == 'ReLN_ode7':
        func = ReLNODEFunc7(device=device).to(device)
    elif args.model_type == 'ReLN_ode8':
        func = ReLNODEFunc8(device=device).to(device)
    elif args.model_type == 'ReLN_ode9':
        func = ReLNODEFunc9(device=device).to(device)
    elif args.model_type == 'ReLN_ode10':
        func = ReLNODEFunc10(device=device).to(device)
    elif args.model_type == 'ReLN_ode11':
        func = ReLNODEFunc11(device=device).to(device)
