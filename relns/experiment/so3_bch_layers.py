...
class SO3EquivariantReluLayers(nn.Module):
    def __init__(self, in_channels):
        ...
        self.ln_fc2 = ReLNLinearAndKillingRelu(feat_dim, feat_dim,share_nonlinearity=share_nonlinearity,leaky_relu=leaky_relu, algebra_type='so3')
        self.ln_fc3 = ReLNLinearAndKillingRelu(feat_dim, feat_dim,share_nonlinearity=share_nonlinearity,leaky_relu=leaky_relu, algebra_type='so3')
        self.ln_fc4 = ReLNLinearAndKillingRelu(feat_dim, feat_dim,share_nonlinearity=share_nonlinearity,leaky_relu=leaky_relu, algebra_type='so3')
...
class SO3EquivariantBracketLayers(nn.Module):
    def __init__(self, in_channels):
        ...
        feat_dim = 1024
        share_nonlinearity = False
        self.ln_fc = ReLNLinearAndLieBracket(in_channels, feat_dim,share_nonlinearity=share_nonlinearity, algebra_type='so3')
        self.ln_fc2 = ReLNLinearAndLieBracket(feat_dim, feat_dim,share_nonlinearity=share_nonlinearity, algebra_type='so3')
        self.ln_fc3 = ReLNLinearAndLieBracket(feat_dim, feat_dim,share_nonlinearity=share_nonlinearity, algebra_type='so3')
        self.ln_fc4 = ReLNLinearAndLieBracket(feat_dim, feat_dim,share_nonlinearity=share_nonlinearity, algebra_type='so3')
        # self.ln_fc5 = ReLNLinearAndLieBracket(feat_dim, feat_dim,share_nonlinearity=share_nonlinearity, algebra_type='so3')
        # self.ln_fc6 = ReLNLinearAndLieBracket(feat_dim, feat_dim,share_nonlinearity=share_nonlinearity, algebra_type='so3')
        # self.ln_fc7 = ReLNLinearAndLieBracket(feat_dim, feat_dim,share_nonlinearity=share_nonlinearity, algebra_type='so3')
...
class SO3EquivariantReluBracketLayers(nn.Module):
    def __init__(self, in_channels):
        ...
        self.ln_fc2 = ReLNLinearAndKillingRelu(
            feat_dim, feat_dim, share_nonlinearity=share_nonlinearity, leaky_relu=leaky_relu, algebra_type='so3')
        self.ln_fc_bracket = ReLNLinearAndLieBracket(in_channels, feat_dim,share_nonlinearity=share_nonlinearity, algebra_type='so3')
