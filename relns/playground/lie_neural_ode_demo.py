...
class ReLNODEFunc(nn.Module):
    ...
    def __init__(self):
        ...
        self.net = nn.Sequential(
            # ReLNLinearAndKillingRelu(1,50,algebra_type='so3'),
            # # ReLNLinear(50,1)
            # ReLNLinearAndKillingRelu(50,1,algebra_type='so3')

            
            ReLNLinearAndLieBracket(1,50,algebra_type='so3'),
            ReLNLinearAndLieBracket(50,1,algebra_type='so3')
            # ReLNLinearAndKillingRelu(1,50,algebra_type='so3'),
            # ReLNLinearAndLieBracket(50,50,algebra_type='so3'),
            # ReLNLinearAndKillingRelu(50,1,algebra_type='so3')
        )
